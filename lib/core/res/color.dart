...
class AppColors {
  ...
  static Color get bgbodyColor => Colors.blue.shade300;
  static Color get bgcardColor => Color.fromARGB(255, 243, 247, 250);
  ...
  static final Color colorProd = Color.fromRGBO(86, 215, 188, 1);
